...
if [[ -f $workflow ]]; then
    ...
    cat /fragpipe_bin/fragpipe-\$fp_version/fragpipe-\$fp_version/workflows/${workflow}.workflow >> selected_workflow_db.workflow
    ...
    cat /fragpipe_bin/fragpipe-\$fp_version/fragpipe-\$fp_version/workflows/${workflow}.workflow >> diann.workflow
